...
export const ProjectProgress = () => {
  ...
  const active = bars.find((b) => b.active) as
    | (typeof bars)[number]
    | undefined;
  const baselineTop = active ? `${100 - active.value}%` : "65%";
        ...
        <div className="relative flex items-start gap-10">
                    ...
                    <div className="relative h-36 w-full flex items-end">
                      <div
                        className={`w-full rounded-2xl ${
                          b.active ? "bg-blue-600 shadow-md" : "bg-slate-800"
                        } transition-all`}
          ...
          <div className="w-32 hidden 2xl:inline flex-shrink-0">
            <div className="flex flex-col items-center gap-3">
              <div className="mt-2">
                <span
                  className="inline-flex items-center rounded-full bg-orange-100 text-orange-600
